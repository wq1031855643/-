...
function forJobs(jobs) {
	for (var i = 0; i < jobs.length; i++) {
		...
		str = '<li><div class="sub_li"><a href="JobMessage?type=posi" target="_blank"><p class="user_title">' + jobs[i].jobName +
			...
			'</p></a><a href="JobMessage?type=posi" class="user_info"><p><img src="' + jobs[i].img + '" />' + jobs[i].companyName +
...
function forCompanys(coms) {
	for (var i = 0; i < coms.length; i++) {
		str = '<li><div class="sub_li"><a class="company_info" href="comdetails?type=com"><img src="' + coms[i].src +
			'" /><div class="company_text"><h4>' + coms[i].name + '</h4><p>' + coms[i].financing + '<span class="vline"></span>' +
			coms[i].business + '</p></div></a><a class="about_info" href="comdetails?type=com"><p><span class="text_blue">' + coms[i].jobCount +
