...
require(["hm", "jquery", "jqmsw"], function(hm, $) {
	hm.creatHead();
	//首页才有l_body这个id元素,为首页添加一个二级联动
	if ($("#l_body").length == 1) {
		$(
			'<div class="nav-city"><p class="nav-city-box"><i class="icon-poi"></i><span class="nav-city-selected f_libcity">深圳</span><span class="switchover-city">[切换城市]</span></p></div>'
		).insertAfter($("#xw_logo"));
=======
require(["hm", "jquery","jqmsw"], function(hm, $) {
	hm.creatHead();
...
>>>>>>> 8a270a56cfc0709c1c22a642c11a3a0189897ea0
	}
	hm.creatFooter();
	if ($("#side").length != 0) {
		hm.creatSide();
...
<<<<<<< HEAD
	...
	$(".f_libcity").on("click", function() {
		if ($(".f_cityList ul").length == 0) {
			var str1 =
				'<div class = "f_cityList"><ul></ul><div class="f_sor"><p></p></div></div><div class = "f_cityOist"><ol></ol><div class="f_sor"><p></p></div></div>';
