define(function () {
	function creatHead(){
		...
		var str = '<div id="xw_wrap" class="xw_wrap"><div id="xw_header" class="xw_header"><div id="xw_her_left" class="xw_her_left"><a id="xw_logo" class="xw_logo" href="#"></a><ul id="xw_nav_left" class="xw_nav_left"><li><a id="home" class="xw_js-left tra" href="index.html?type=home">首页</a></li><li><a id="posi" class="tra" href="posi.html?type=posi">职位</a></li><li><a id="com" class="tra" href="company.html?type=com">公司</a></li><li><a id="app" class="tra" href="app.html?type=app">APP</a></li><li><a id="zx" class="tra" href="message.html?type=zx">资讯</a></li></ul></div><div id="xw_her_right" class="xw_her_right"><a id="xw_enter" class="xw_enter tra" href="login.html?type=login">登陆</a><a id="xw_sign" class="xw_sign tra" href="login.html?type=add">注册</a><ul id="xw_nav_right" class="xw_nav_right"><li><a class="tra" href="login.html?type=add">我要招聘</a></li><li><a class="tra" href="resume.html">我要找工作<span class="xw_spa">hot</span></span></li><li><a class="tra" href="resume.html">上传简历</a></li></ul></div></div></div>';
		head.innerHTML += str;
	}
